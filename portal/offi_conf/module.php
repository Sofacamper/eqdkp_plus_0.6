 ...
 * -----------------------------------------------------------------------
 * Began:       2009
 * Date:        $Date: 2010-12-05 20:51:33 +0100 (Sun, 05 Dec 2010) $
 * -----------------------------------------------------------------------
...
$portal_module['offi_conf'] = array(
			...
			'positions'      => array('left1', 'left2', 'right'),
      		'signedin'       => '1',
      		'custom_tables'  => array('module_offi_conf'),
      		'install'        => array(
			                      'autoenable'        => '0',
  ...
  function offi_conf_module()
  {
	...
	if(!$offi_conf) {
		...
		while ( $row = $db->fetch_record($result) ) {
			...
			$offi_conf .= $html->ToolTip($tooltip, "<img src='{$eqdkp_root_path}libraries/myHTML/images/help_small.png' border='0' alt='' align='absmiddle' />");
