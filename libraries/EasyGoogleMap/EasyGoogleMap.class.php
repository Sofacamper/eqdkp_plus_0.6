...
class EasyGoogleMap {
	 ...
	 * @return: string
	 */
	function MapHolder($onclick='') {
	  $myOnClick = ($onclick) ? 'onclick="'.$onclick.'" ' : '';
		return "<div id=\"map\"".$myOnClick." style=\"width: ".$this->mMapWidth."px; height: ".$this->mMapHeight."px;\"></div>";
	} # end function
