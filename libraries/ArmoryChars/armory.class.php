 ...
 * -----------------------------------------------------------------------
 * Began:       2007
 * Date:        $Date: 2010-12-20 20:27:50 +0100 (Mon, 20 Dec 2010) $
 * -----------------------------------------------------------------------
 ...
 * @version     $Rev: 9441 $
 * 
 * $Id: armory.class.php 9441 2010-12-20 19:27:50Z wallenium $
 */
...
class PHPArmory
{
  ...
  * @return string output
  */
  public function Link($loc, $username, $server, $mode='char', $guild=''){
		global $user;
		// init the variables
