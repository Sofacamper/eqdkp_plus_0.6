...
input.button, input.liteoption, input.mainoption {
	...
	/*background:#EEEEEE;*/
	border: #000000 solid 0px;;
	border-bottom: solid 0px #418e74;
	border-right: solid 0px #418e74;
	background-image:url(images/button.jpg);
   width: auto;
   height: 18px;
	font-size:9px;
	padding : 1px;
	border:1px solid #418e74;
}
...
#rrs_news div.title {
	...
	font-size: 11px;
	color: #ffffff;
	background: #138567 url(images/head.jpg) repeat-x top;
	border: 0px solid #215d7f;
}

#rrs_news div.title:hover {
	color: #ffffff;
	background: #00bb89 url(images/head_hl.jpg) repeat-x top;
}
...
#navigation {
    background: url("images/navi-links.png") no-repeat scroll -2px -5px transparent;
    display: block;
    height: 179px;
    padding-left: 181px;
}
...
#navigation-expand {
    background: url("images/navi-rechts.png") no-repeat scroll right -7px transparent;
    font-style: normal;
    height: 175px;
    padding-left: 0;
    width: 100%;
