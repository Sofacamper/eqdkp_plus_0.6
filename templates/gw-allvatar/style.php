...
.row1viewnews {
	background: #bb7a4e repeat-x top;
}
...
#rrs_news div.title {
	...
	font-size: 11px;
	color: #ffffff;
	background: #8d4a2d url(images/head.jpg) repeat-x top;
	border: 0px solid #215d7f;
}

#rrs_news div.title:hover {
	color: #ffffff;
	background: #8d4a2d url(images/head_hl.jpg) repeat-x top;
}
...
#navigation {
    background: url("images/navi-links.png") no-repeat scroll -56px -18px transparent;
    display: block;
    height: 179px;
    padding-left: 267px;
}
...
#navigation-expand {
    background: url("images/navi-rechts.png") no-repeat scroll right -69px transparent;
    font-style: normal;
    height: 209px;
    padding-left: 0;
    width: 113%;
...
#inner_wrapper {
    background: none repeat scroll 0 0 #BB7A4E;
    margin: 10px auto;
    width: 100%;
}
