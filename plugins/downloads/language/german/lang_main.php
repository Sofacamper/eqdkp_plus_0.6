...
$lang['dl_alpha_status'] 			= '<b>Dies ist eine unfertige ALPHA-Version und NICHT für den produktiven Einsatz gedacht!</b>';
$lang['dl_beta_status'] 			= '<b>Dies ist eine BETA-Version und NICHT für den produktiven Einsatz gedacht!</b><br>Melde bitte Fehler in unser <a href="http://eqdkp-plus.com/forum">Forum</a>.';
...
$lang['dl_import_info'] 					= 'Dateien zum Importieren müssen in folgenden Ordner hochgeladen werden:';
$lang['dl_import_success'] 					= 'Die ausgewählten Dateien wurden erfolgreich importiert';
$lang['dl_import_footcount'] 				= '... %d Datei(en) zum Importieren gefunden';
//Statistics
$lang['dl_month_1'] = "Januar";
$lang['dl_month_2'] = "Februar";
$lang['dl_month_3'] = "März";
...
$lang['dl_select_time'] = "Zeitraum auswählen";
$lang['dl_filter'] = "Filtern nach";
$lang['dl_load'] = "Laden";

$lang['dl_attachment'] = "Angehängte Datei";
$lang['dl_times_downloaded'] = "%dx heruntergeladen";

$lang['dl_stats_caching_info'] = "Aufgrund Caching können diese Daten bis zu 24 Stunden alt sein. (<a href=\"statistics.php?do=del_cache\">Cache löschen</a>)";
...
$lang['dl_admin_action'] 			= 'Admin-Menü  <img src="'.$eqdkp_root_path.'plugins/downloads/images/down.png">';
...
$lang['dl_ad_move_success'] 		= '<img src="'.$eqdkp_root_path.'plugins/downloads/images/ok.png">Die ausgewählten Downloads wurden erfolgreich verschoben.';
...
$lang['dl_ad_conf_filesize_limit'] 				= 'Maximale Dateigröße:';
$lang['dl_ad_conf_folder_limit'] 				= 'Maximale Größe des Upload-Ordners:';
...
$lang['dl_ad_conf_single_vote'] 				= 'User dürfen Download nur einmal bewerten:';
$lang['dl_ad_conf_statistics'] 					= 'Statistiken aktivieren:';
$lang['dl_ad_conf_prune_statistics'] 			= 'Statistik-Daten älter als xx Tage automatisch löschen:';
$lang['dl_ad_conf_statistics_reset'] 			= 'Statistiken zurücksetzen:';
$lang['dl_ad_conf_statistics_reset_warn'] 		= 'Möchtest du wirklich alle Statistiken löschen?';
$lang['dl_ad_conf_statistics_ov'] 				= 'Statistiken auf der Übersichts-Seite anzeigen:';
...
$lang['dl_ad_conf_disable_mimecheck_warning'] 	= 'Per Mime-Type Check werden hochgeladene Dateien überprüft, ob ihre Dateiendung und ihr Mime-Type zueinander passen. Dies geschieht aus Sicherheitsgründen.<br>Deaktiviere diese Funktion nur, wenn Dateien aus absolut vertrauenswürdigen Quellen hochgeladen werden. <br> <br> <b>Das Deaktivieren dieser Funktion wird nicht empfohlen!</b>';
...
$lang['dl_help_related_links']		= 'Trage hier IDs (durch Komma getrennt) von anderen Downloads ein, die bei diesem Downloads als "zugehörige Downloads" erscheinen. Die ID eines Downloads bekommst du z.B. aus der URL: "downloads.php?file=3". Hier wäre die ID "3".';
$lang['dl_help_recaptcha']			= 'Nicht registrierte User müssen vor dem Download einer lokalen Datei ein CAPTCHA lösen. Die Aktivierung dieser Funktion spart Traffic, da nur Menschen eine Datei herunterladen können. Ein kostenloser Account bei reCAPTCHA.net ist dafür erforderlich. Trage die Keys in den PLUS-Einstellungen->Libraries ein';
$lang['dl_help_statistics']			= 'Aktiviert ausführliche Statistiken über die Anzahl der Downloads im zeitlichen Zusammenhang';
$lang['dl_help_prune_statistics']	= 'Löscht automatisch alle Statistik-Daten, die älter sind als x Tage. Leer lassen, um Funktion nicht zu aktivieren.';
$lang['dl_help_statistics_ov']			= 'Blendet Statistiken wie z.B. monatlicher und totaler Traffic, neuester Downloads, TOP5-Downloads usw. auf der Übersichts-Seite ein.';
...
$lang['dl_help_filesize_limit']					= 'Trage hier die maximale Größe einer hochgeladenen Datei ein. Lasse dieses Feld leer, wenn kein Limit erwünscht ist (es wird dann die Servereinstellung verwendet).';
$lang['dl_help_folder_limit']					= 'Trage hier die maximale Größe des Upload-Ordners ein. Lasse dieses Feld leer, wenn kein Limit gewünscht ist.';
...
$lang['dl_cat_delete_warn']				= 'Die gewählte Kategorie enthält noch Dateien, die beim Löschen verloren gehen würden.';
...
$lang['dl_l_delete_votes'] 				= 'Bewertungen zurücksetzen';
...
$lang['dl_l_cache_not_writable'] 		= 'Der Cache-Ordner "data" ist nicht beschreibar. Ändere die CHMOD-Rechte in 0777!';
...
$lang['dl_index_error_traffic'] = '<img src="'.$eqdkp_root_path.'plugins/downloads/images/credits/info.png">Das monatliche Traffic-Limit ist erreicht. Bitte Lade die Datei von einem alternativen Downloadserver (falls angegeben) oder nächsten Monat herunter.';
