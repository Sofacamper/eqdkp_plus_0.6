 ...
 * -----------------------------------------------------------------------
 * Began:       2008
 * Date:        $Date: 2009-08-03 23:41:08 +0200 (Mon, 03 Aug 2009) $
 * ----------------------------------------------------------------------- 
 ...
 * @version     $Rev: 5428 $
 * 
 * $Id: libloader.inc.php 5428 2009-08-03 21:41:08Z wallenium $
 */
  
  // Configuration
  $myPluginID       = 'charmanager';         // Plugin ID, p.e. 'raidplan'
