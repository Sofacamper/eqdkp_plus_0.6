...
$tpl->assign_vars(array(
  'DL_I_ITEM_NAME'   	=> 'credits/fs_logo.png',
  'DL_L_VERSION'      => $pm->get_data('fightstats', 'version').$dl_status,
  'DL_L_DEVTEAM'			=> 'Copyright',
  'DL_L_YEARR'				=> ( $act_year == 2010) ? $act_year : '2010 - '.$act_year,
  'DL_L_TXT_DEVTEAM'  	=> 'GodMod',
  'DL_L_URL_WEB'      	=> 'Web',
  'DL_D_WEB_URL'      	=> 'www.eqdkp-plus.com',
  'DL_L_ADDITONS'     	=> $user->lang['fs_additionals'],
  'DL_L_LICENCE'				=> $user->lang['fs_licence'],
));


$eqdkp->set_vars(array(
  'page_title'    => $user->lang['fightstats'],
