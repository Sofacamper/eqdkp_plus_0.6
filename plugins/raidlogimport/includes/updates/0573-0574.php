...
$new_version    = '0.5.7.4';
$updateFunction = 'add_cata_tier12';
...
function add_cata_tier12() {
	...
	include($file);
	if(count($bz_data) < 157) include($eqdkp_root_path.'plugins/raidlogimport/games/WoW/language/english/bz_sql.php');
	$data2import = array();
	$zones = array();
