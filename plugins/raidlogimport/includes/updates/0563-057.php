...
$new_version    = '0.5.7.0';
$updateFunction = 'add_cata_tier11';
...
function add_cata_tier11() {
	...
	include($file);
	if(count($bz_data) < 90) include($eqdkp_root_path.'plugins/raidlogimport/games/WoW/language/english/bz_sql.php');
	$data2import = array();
	$zones = array();
