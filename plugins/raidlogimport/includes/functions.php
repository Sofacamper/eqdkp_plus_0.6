 ...
 * -----------------------------------------------------------------------
 * Began:       2008
 * Date:        $Date: 2010-02-10 17:20:09 +0100 (Wed, 10 Feb 2010) $
 * -----------------------------------------------------------------------
 ...
 * @version     $Rev: 7200 $
 *
 * $Id: functions.php 7200 2010-02-10 16:20:09Z hoofy_leon $
 */
...
function lang2tpl()
{
	...
	$la_ar = array(
        ...
        'L_DIFF1'		=> $user->lang['diff_1'],
        'L_DIFF2'		=> $user->lang['diff_2'],
        ...
        'L_RECALC_RAIDN'=> $user->lang['rli_calc_note_value'],
        'L_RECALC_RAID' => $user->lang['rli_calc_event_boss'],
