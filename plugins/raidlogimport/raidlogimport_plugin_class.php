 ...
 * @version     $Rev: 11492 $
 *
 * $Id: raidlogimport_plugin_class.php 11492 2011-12-02 12:04:59Z hoofy $
 */
    ...
    function raidlogimport_plugin_class($pm)
    {
    	...
    	if (!($this->pm->check(PLUGIN_INSTALLED, 'raidlogimport')))
    	{
			...
			$config_data = array(
				...
				'timezone_offset'	=> '0',		//number of hours to add/substract to read times from log
				'del_dbl_times'		=> '0'		//delete double join (later) or leaves (earlier)
			);
