 ...
 * @version     $Rev: 10151 $
 *
 * $Id: settings.php 10151 2011-03-21 16:07:19Z hoofy $
 */
...
class RLI_Settings extends EQdkp_Admin
{
	...
	function display_form($messages=array())
	{
		...
		$parser = array(
			...
			'rift' => $user->lang['parser_rift'],
			'dkplp' => $user->lang['parser_dkplp']
		);
		...
		$configs = array(
			...
			'yes_no'	=> array(
				'general'		=> array('rli_upd_check', 'del_dbl_times'),
			...
			'normal'	=> array(
				'general'		=> array('timedkp_handle', 'timezone_offset'),
